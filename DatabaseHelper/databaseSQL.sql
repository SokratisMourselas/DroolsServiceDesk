...
-- Dumping data for table springdrools.comment: ~2 rows (approximately)
DELETE FROM `comment`;
/*!40000 ALTER TABLE `comment` DISABLE KEYS */;
INSERT INTO `comment` (`id`, `comment`, `requestId`) VALUES
                                                            (1, 'This is a dummy comment message!', 1),
                                                            (2, 'This comment has been added with two users', 4);
/*!40000 ALTER TABLE `comment` ENABLE KEYS */;

-- Dumping structure for table springdrools.comment_user
CREATE TABLE IF NOT EXISTS `comment_user` (
  `commentId` int(11) NOT NULL,
  `userId` int(11) NOT NULL,
  PRIMARY KEY (`commentId`,`userId`),
  KEY `FK_user_05` (`userId`),
  CONSTRAINT `FK_comment_05` FOREIGN KEY (`commentId`) REFERENCES `comment` (`id`),
  CONSTRAINT `FK_user_05` FOREIGN KEY (`userId`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=ascii;

-- Dumping data for table springdrools.comment_user: ~3 rows (approximately)
...
-- Dumping data for table springdrools.request: ~4 rows (approximately)
DELETE FROM `request`;
...
INSERT INTO `request` (`id`, `teamDirectedTo`, `rule`, `message`, `project`, `userId`) VALUES
                                                                                              ...
                                                                                              (4, 'SPECS', 'R0987', 'Checking ManyToMany relation', 'AES 1.1', 3);
...
-- Dumping data for table springdrools.user: ~3 rows (approximately)
DELETE FROM `user`;
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` (`id`, `username`, `password`, `email`) VALUES
                                                                  (3, 'Sokratis Mourselas', 'ExamplePassword', 'example@springMVC.com'),
                                                                  (19, 'xiqyxadu', 'Consequat Incididun', 'segoku@mailinator.com'),
                                                                  (20, 'socmour', 'dfd', 'garampatzis@pem.tuc.gr');
